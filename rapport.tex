...
%\input{pagedegarde}
\input{macros}
\title{Étude des transferts horizontaux de l’endosymbionte \textit{Wolbachia}à une échelle microévolutive, par la technique du Transposon Display, dans le contexte }
