...
\paragraph{} % (fold)
\label{par:vide}
Pour finir, nous pourrions dans une visoin à plus long terme envisager des études similaires sur d'autres marqueurs qu'ISWpi1, choisi certes pour sa spécificité pour \esp{Wolbachia}, mais aussi par-ce qu'il est à l'heure actuelle, le plus décrit dans la littérature. Cela nous permettrait d'accroitre encore d'avantage la résolution de notre vision des micro-évolutions au sein de ce groupe.
% paragraph  (end)
