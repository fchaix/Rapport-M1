...
Nous pouvons d'ailleurs noter que la bactérie \esp{Wolbachia}, étudiée ici, se situe dans cette limite floue, se comportant en fonction de l'hôte tantôt comme un parasite aux effets négatifs sur l'hôte\cite{Werren2008}, tantôt comme un symbiote en protégeant par exemple son hôte des virus.}
...
Cependant, la bactérie endosymbiote \esp{Wolbachia} ne suit pas cette tendance. En effet, les études des souches \esp{wMel} et \esp{wRi} notamment ont montré une fréquence de recombinaison nettement supérieure aux autres bactéries intracellulaires obligatoires\cite{Wu2004}.

D'autre part, une caractéristique très importante de \esp{Wolbachia} est la grande variété de ses hôtes. 
...
Les transferts les plus récents sont détéctés par une similarité entre deux \esp{Wolbachia} issus d'hôtes différents, sur la base de gènes habituellement suffisamment variables pour différencier deux souches intra-spécifiques.
