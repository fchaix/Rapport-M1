...
Les transferts les plus récents sont mis en évidence par une similarité entre deux \esp{Wolbachia} issus d'hôtes différents, sur la base de gènes habituellement suffisamment variables pour différencier deux souches intra-spécifiques.
